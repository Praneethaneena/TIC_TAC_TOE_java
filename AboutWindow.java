...
public class AboutWindow extends JDialog implements MouseListener {
    ...
    public AboutWindow() {
        ...
        labelLogo = new JLabel(new ImageIcon(getClass().getResource("C:\\Users\\pottu\\Downloads\\logo_tic_tac_toe.jpg")));
        ...
        for (int i = 0; i < NUMBER_OF_IMAGES; i++) {
        	labelImg[i] = new JLabel(new ImageIcon(getClass().getResource("C:\\Users\\pottu\\Downloads\\logos" + IMAGE_NAME[i]+ ".png")));
        ...
        labelCopyRight = new JLabel("Copyright Ⓒ "); // Create New Instance From JLabel & Set By Paragraph
